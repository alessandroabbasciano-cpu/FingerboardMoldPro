 ...
 **New: SideLocks System**:
Added `SideLocks` (Bool). When enabled, it generates pentagonal guide rails on the sides of the mold. This allows you to print the Male and Female parts standing vertically on the print bed **without any supports**, ensuring the smoothest possible surface finish on the pressing face.
